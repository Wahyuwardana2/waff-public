...
import logo from "../assets/WaffIcon.svg";
...
function Storefront() {
  ...
  if (status === "loading") {
    ...
    return (
      <>
        <Helmet>
          <title>{store.storeName} - W-Aff</title>
        </Helmet>
        <div className=" poppins">
          ...
          <div className="mx-0 lg:mx-20 max-w-7xl 2xl:mx-auto xl:mx-36">
            {store.coverImg ? (
              ...
              <div
                className={`w-full h-44 lg:h-60 m-auto object-cover rounded-b-xl ${store.colorTheme + "-tag"
                  }`}
              ></div>
            )}
          </div>
          ...
          <div className="-translate-y-20 xl:px-[152px] xl:mx-auto max-w-7xl 2xl:mx-auto 2xl:px-2 px-2 md:px-6 gap-1 flex flex-col lg:px-[84px] pb-2">
            <div className="flex items-end justify-between">
              ...
              <div className="col-span-2 ml-auto translate-y-1 md:translate-y-0">
                <CopyToClipboard
                  text={`${window.location.origin}/${store.storeName}`}
                  className="cursor-pointer"
                  onCopy={() => toast.success("Copied!")}
                >
                  <span>
                    <div
                      className={`flex items-center w-fit gap-3 py-2 text-white cursor-pointer font-medium rounded-md px-3 ${store.colorTheme + "-btn"
                        }`}
                    >
            ...
            <div className="flex sm:flex-row items-start sm:items-center flex-col gap-1 sm:gap-5 text-sm text-gray-500">
              <div className="flex items-center gap-1">
                ...
                <p>{window.location.origin}/{store.storeName}</p>
              </div>
              <div className="flex items-center gap-1">
          ...
          <div className="mb-10 text-center flex items-center justify-center text-sm">
            <p>
              Powered by <br />{" "}
              <span
                className="text-2xl font-semibold cursor-pointer text-orange-600"
                onClick={() => navigate("/")}
              >
                W-Aff
              </span>
