          ...
          <div className="flex items-start justify-between">
            ...
            <div className="md:flex-row flex flex-col items-start md:items-center gap-3">
              <img
                ...
                alt=""
                className="w-16 h-16 rounded-full p-[2px] border-2 border-orange-600 object-cover"
              />
              <div>
                  ...
                  <span>
                    ...
                    {window.location.origin}/{store.storeName}
                      <Icon
                        ...
                        width="20"
                        className="text-orange-600 hover:scale-110 transition-all duration-75 ease-out cursor-pointer"
                      />
                    </p>
                  </span>
                </CopyToClipboard>
