...
function EditProduct() {
  ...
  return (
    <>
      <Helmet>
        <title>Edit Product | W-Aff</title>
      </Helmet>
                ...
                <div>
                  ...
                  <div className="my-1 justify-end flex gap-3 md:">
                    <button
                      ...
                      onClick={() => navigate("/app/products")}
                      className={`batalkanBtn ${(loading || !isChange) && "opacity-75 hover:bg-white"
                        } `}
                    >
                      Batalkan
                    </button>
                    <button
                      type="submit"
                      disabled={loading || !isChange}
                      className={`simpanBtn ${(loading || !isChange) &&
                        "opacity-75 hover:bg-orange-600"
                        }`}
                    >
                      Simpan Produk
                    </button>
