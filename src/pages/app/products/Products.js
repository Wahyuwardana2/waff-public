        ...
        <div className="contentContainer">
          ...
          <div className="flex w-full my-2">
            <input
              ...
              value={filterInput}
              className="w-full focus:border-orange-600 text-sm outline-none border-[1px] border-gray-300 transition-all duration-300 ease-out  rounded p-2"
            />
            {/* <button>
              Cari
            </button> */}
