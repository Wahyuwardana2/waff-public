...
function Setting() {
  ...
  const [color, setColor] = useState(
    store.colorTheme ? store.colorTheme : "orange"
  );
            ...
            >
              ...
              <div className="relative z-0">
                {!changedCover ? (
                  <>
                    {store?.coverImg ? (
                      ...
                      <div className="h-44 rounded-t-lg flex items-center justify-center text-white w-full bg-orange-600">
                ...
                <button
                  ...
                  className="absolute bottom-4 rounded py-1 px-4 bg-orange-200 border-[1px] border-orange-600 hover:bg-orange-300 font-medium right-4 text-sm"
                >
                  Ganti Cover
                </button>
                <input
                ...
                <div className="flex items-center gap-4">
                  {!changedImg ? (
                    <img
                      ...
                      className="w-20 h-20 object-cover p-1 my-2 border-orange-700 border-2 rounded-full"
                      alt="foto profile"
                    />
                  ) : (
                    <img
                      src={URL.createObjectURL(changedImg)}
                      className="object-cover w-20 h-20 p-1 my-2 border-orange-700 border-2 rounded-full"
                      alt="foto profile"
                    />
                  )}
                  <button
                    ...
                    className="text-sm p-2 hover:bg-orange-300 bg-orange-200 rounded font-medium"
                  >
                    Unggah Foto
                  </button>
                  {/* Ref Img */}
              ...
              <div className="my-1 justify-end flex">
                <button
                  ...
                  className={`simpanBtn ${(loading || !isChange) && "opacity-75 hover:bg-orange-600"
                    }`}
                >
