...
function Cart() {
  ...
  return (
    <>
      <Helmet>
        <title>Keranjang Belanja - W-Aff</title>
      </Helmet>
      <NavbarStore />
      <div className="max-w-5xl px-4 mx-auto  my-8 poppins">
        {cart.length > 0 && (
          <button
            className={`flex items-center font-medium cursor-pointer mb-4  ${color + "Nav"
              } `}
            onClick={() => navigate(-1)}
          >
        ...
        {cart.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-5 gap-2 md:gap-6 my-2">
            ...
            <div className=" col-span-2">
              ...
              <div className="border-[1.2px] mt-[10px] flex flex-col gap-2 border-gray-200 p-3 rounded-md">
                ...
                <button
                  className={`font-semibold mt-3 rounded text-white p-3 ${color + "-btn"
                    } `}
          ...
          <div className="col-span-5 flex flex-col items-center text-center">
            ...
            <button
              className="font-medium text-lg py-2 px-16 hover:bg-orange-700 rounded mt-4 bg-orange-600 text-white"
              onClick={() => navigate(-1)}
            >
              Kembali
            </button>
