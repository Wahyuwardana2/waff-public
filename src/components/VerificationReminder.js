...
function VerificationReminder() {
  ...
  return (
    <div className="my-3 bg-orange-100 border-2 border-orange-600 rounded-md p-4 font-medium">
      <p>
        <span className="text-xl">😓</span> Silahkan konfirmasi email terlebih dahulu untuk mengakses toko.{" "}
        <span className="font-semibold text-orange-600 underline cursor-pointer" onClick={resendVerification}>
          Kirim Ulang
        </span>
      </p>
    </div>
