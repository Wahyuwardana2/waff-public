...
function GoogleLogin() {
  ...
  return (
    <button onClick={loginHandler} className="border-2 border-gray-300 gap-4 rounded-full p-3 font-semibold items-center flex justify-center transition-all duration-300 hover:border-orange-600 cursor-pointer">
