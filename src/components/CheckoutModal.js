      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 max-w-xl mx-auto">
        <Dialog.Panel className="bg-white pt-3 pb-6 px-6 rounded-md">
          <div className="flex items-center justify-between pb-1 border-b-[1px] border-b-gray-300">
            <Dialog.Title className="font-semibold text-orange-600 text-[17px]">
              {mode === "login"
          ...
          <form className="flex flex-col mt-3 gap-2" onSubmit={submitHandler}>
            <div>
              ...
              <input
                type="text"
                className="border-[1px] w-full border-gray-400 rounded outline-none p-2 text-sm focus:border-orange-600"
          ...
          <button
            ...
            className="border-2 w-full border-gray-300 gap-3 rounded-full p-2 font-semibold items-center flex justify-center transition-all duration-300 hover:border-orange-600 cursor-pointer"
          >
