        ...
        <Dialog.Panel className="bg-white pt-3 pb-6 px-6 rounded-md w-4/5">
          ...
          <div className="w-full my-2 font-medium gap-2 flex flex-col">
            <Link
              to="/"
              onClick={() => setIsOpen(false)}
              className={`py-1 ${locationNow.pathname === "/" && "text-orange-600"
                } `}
            >
              <p>Home</p>
            </Link>
            <Link
              to="/faq"
              onClick={() => setIsOpen(false)}
              className={`py-1 ${locationNow.pathname.includes("/faq") && "text-orange-600"
                } `}
            >
              <p>Faq</p>
            </Link>
            <Link
              to="/login"
              onClick={() => setIsOpen(false)}
              className={`py-1 ${locationNow.pathname.includes("/login") && "text-orange-600"
                } `}
            >
              <p>Login</p>
            </Link>
            <Link
              to="/signup"
              onClick={() => setIsOpen(false)}
              className="rounded-3xl flex items-center justify-center mt-3 p-2 text-[15px]  font-medium bg-orange-500 text-white"
            >
